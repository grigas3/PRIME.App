...
import com.example.primeapp.sensor.IMUAgent;
        ...
        mwBoard.connectAsync().continueWithTask(task -> {
                    ...
                    if (!task.isCancelled()) {
                        ...
                        if (mwBoard.getModule(SensorFusionBosch.class) == null) {
                            ...
                            navActivityIntent.putExtra(MainActivity.EXTRA_BLE_DEVICE, device);
                            startActivityForResult(navActivityIntent, SCAN_DEVICE);
                        }
                    }
